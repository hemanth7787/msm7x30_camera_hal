...
#ifndef _CAMERA_DEVICE_H
#define _CAMERA_DEVICE_H
...
class CameraDevice {
public:
    /* Constructs CameraDevice instance.
     * Param:
    ...
    /***************************************************************************
     *  Camera Device abstract interface
     **************************************************************************/
...
public:
    ...
    inline bool isInitialized() const {
        ...
        return mWorkerThread.get() != NULL && mState != CDS_CONSTRUCTED;
    }
    inline bool isConnected() const {
        /* Instance is connected when its status is either"connected", or
         * "started". */
        return mState == CDS_CONNECTED || mState == CDS_STARTED;
    }
    inline bool isStarted() const {
        return mState == CDS_STARTED;
    }
...
protected:
    ...
    class WorkerThread : public Thread {
        ...
        public:
            inline explicit WorkerThread(CameraDevice* camera_dev)
...
protected:
    ...
    /* Defines possible states of the  camera device object.
     */
    ...
    /* Object state. */
    CameraDeviceState   mState;
};

}; /* namespace android */

#endif  /* _CAMERA_DEVICE_H */
